...
final class Version20221202085235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (
            ...
            user_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE `order` (
            ...
            tracking_order VARCHAR(255) DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE product (
            ...
            created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
            updated_at DATETIME DEFAULT NULL, release_at DATETIME DEFAULT NULL, 
            summary LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, 
            weight NUMERIC(10, 3) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, 
