 ...
 */
final class Version20221121134819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE custom (id INT AUTO_INCREMENT NOT NULL, custom_order_id INT DEFAULT NULL, attribut_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, quantity INT DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, INDEX IDX_F584169B684D8A5C (custom_order_id), INDEX IDX_F584169B51383AF3 (attribut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_details (id INT AUTO_INCREMENT NOT NULL, my_order_id INT DEFAULT NULL, product_id INT DEFAULT NULL, quantity INT DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, total DOUBLE PRECISION DEFAULT NULL, taxe VARCHAR(255) NOT NULL, primary_offer_name VARCHAR(255) DEFAULT NULL, primary_offer_reduce INT DEFAULT NULL, primary_type_reduce VARCHAR(255) DEFAULT NULL, secondary_offer_name VARCHAR(255) DEFAULT NULL, secondary_offer_reduce INT DEFAULT NULL, secondary_type_reduce VARCHAR(255) DEFAULT NULL, custom_price DOUBLE PRECISION DEFAULT NULL, custom_description LONGTEXT DEFAULT NULL, INDEX IDX_845CA2C1BFCDF877 (my_order_id), INDEX IDX_845CA2C14584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
