 ...
 */
final class Version20221122080635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribut (
            id INT AUTO_INCREMENT NOT NULL, 
            ...
            perso_is_enable TINYINT(1) DEFAULT NULL, 
            INDEX IDX_7AB8E85D4584665A (product_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentary (
            ...
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE custom (
            id INT AUTO_INCREMENT NOT NULL, 
            custom_order_id INT DEFAULT NULL, 
            attribut_id INT DEFAULT NULL, 
            description LONGTEXT DEFAULT NULL, 
            quantity INT DEFAULT NULL, 
            price DOUBLE PRECISION DEFAULT NULL, 
            INDEX IDX_F584169B684D8A5C (custom_order_id), 
            INDEX IDX_F584169B51383AF3 (attribut_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE featured_products (
            id INT AUTO_INCREMENT NOT NULL, 
            product_id INT DEFAULT NULL, 
            position INT DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE maintenance (
            ...
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE news_letter (
            id INT AUTO_INCREMENT NOT NULL, 
            name VARCHAR(255) DEFAULT NULL, 
            title VARCHAR(255) DEFAULT NULL, 
            description LONGTEXT DEFAULT NULL, 
            created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
            summary LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE news_letter_user (
            id INT AUTO_INCREMENT NOT NULL, 
        ...
        $this->addSql('CREATE TABLE offer (
            ...
            started_at DATETIME DEFAULT NULL, 
            ended_at DATETIME DEFAULT NULL, 
            type_reduce VARCHAR(255) DEFAULT NULL, 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offer_product (
            offer_id INT NOT NULL, 
            product_id INT NOT NULL, 
            INDEX IDX_7242C2A453C674EE (offer_id), 
            INDEX IDX_7242C2A44584665A (product_id), 
            PRIMARY KEY(offer_id, product_id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (
            ...
            INDEX IDX_F52993988486F9AC (adress_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_details (
            ...
            primary_offer_name VARCHAR(255) DEFAULT NULL, 
            primary_offer_reduce INT DEFAULT NULL, 
            primary_type_reduce VARCHAR(255) DEFAULT NULL, 
            secondary_offer_name VARCHAR(255) DEFAULT NULL, 
            secondary_offer_reduce INT DEFAULT NULL, 
            secondary_type_reduce VARCHAR(255) DEFAULT NULL, 
            custom_price DOUBLE PRECISION DEFAULT NULL, 
            custom_description LONGTEXT DEFAULT NULL, 
            INDEX IDX_845CA2C1BFCDF877 (my_order_id), 
            INDEX IDX_845CA2C14584665A (product_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pages (
            ...
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parent_category (
            id INT AUTO_INCREMENT NOT NULL, 
            name VARCHAR(255) DEFAULT NULL, 
            image VARCHAR(255) DEFAULT NULL, 
            slug VARCHAR(255) DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE promo_code (
            ...
            ended_at DATETIME DEFAULT NULL, 
            is_active TINYINT(1) DEFAULT NULL, 
            reduce DOUBLE PRECISION DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE shipping (
            id INT AUTO_INCREMENT NOT NULL, 
            order_shipping_id INT DEFAULT NULL, 
            name VARCHAR(255) DEFAULT NULL, 
            description LONGTEXT DEFAULT NULL, 
            price DOUBLE PRECISION DEFAULT NULL, 
            INDEX IDX_2D1C172453358C7E (order_shipping_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE shop (
            ...
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE social (
            id INT AUTO_INCREMENT NOT NULL, 
            name VARCHAR(255) DEFAULT NULL, 
            link LONGTEXT DEFAULT NULL, 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE taxe (
            id INT AUTO_INCREMENT NOT NULL, 
            name VARCHAR(255) DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE wishlist (
            ...
            user_id INT DEFAULT NULL, 
            product_id INT DEFAULT NULL, 
            INDEX IDX_9CE12A31A76ED395 (user_id), 
            INDEX IDX_9CE12A314584665A (product_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (
            ...
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
            COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F81A76ED395 
        FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE attribut ADD CONSTRAINT FK_7AB8E85D4584665A 
        FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1727ACA70 
        FOREIGN KEY (parent_id) REFERENCES parent_category (id)');
        $this->addSql('ALTER TABLE commentary ADD CONSTRAINT FK_1CAC12CAA76ED395 
        FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE commentary ADD CONSTRAINT FK_1CAC12CA4584665A 
        FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE custom ADD CONSTRAINT FK_F584169B684D8A5C 
        FOREIGN KEY (custom_order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE custom ADD CONSTRAINT FK_F584169B51383AF3 
        FOREIGN KEY (attribut_id) REFERENCES attribut (id)');
        $this->addSql('ALTER TABLE featured_products ADD CONSTRAINT FK_BB76A6674584665A 
        FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE offer_product ADD CONSTRAINT FK_7242C2A453C674EE 
        FOREIGN KEY (offer_id) REFERENCES offer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE offer_product ADD CONSTRAINT FK_7242C2A44584665A 
        FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398A76ED395 
        FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993988486F9AC 
        FOREIGN KEY (adress_id) REFERENCES address (id)');
        $this->addSql('ALTER TABLE order_details ADD CONSTRAINT FK_845CA2C1BFCDF877 
        FOREIGN KEY (my_order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE order_details ADD CONSTRAINT FK_845CA2C14584665A 
        FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD1AB947A4 
        FOREIGN KEY (taxe_id) REFERENCES taxe (id)');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD12469DE2 
        FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 
        FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE shipping ADD CONSTRAINT FK_2D1C172453358C7E 
        FOREIGN KEY (order_shipping_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE wishlist ADD CONSTRAINT FK_9CE12A31A76ED395 
        FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE wishlist ADD CONSTRAINT FK_9CE12A314584665A 
        FOREIGN KEY (product_id) REFERENCES product (id)');
    }
